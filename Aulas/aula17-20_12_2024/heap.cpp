...
int main() {
  printf("Subir -------------------------------\n");
  int qnt1 = 8;
  int array1[qnt1] = {90, 58, 83, 35, 12, 99, 79, 20};
  printarArray(array1, qnt1);
  subir(array1, 5, qnt1);
  printf("\nDescer --------------------------------\n");
  int array2[qnt1] = {40, 58, 83, 35, 12, 65, 79, 20};
  printarArray(array2, qnt1);
  descer(array2, 0, qnt1);
  printf("\nInserir -------------------------------\n");
  int qnt2 = 8;
  int array3[qnt2] = {83, 58, 79, 35, 12, 65, 40, 20};
  printarArray(array3, qnt2);
  inserir(array3, 55, &qnt2);
  printf("\nRemover -------------------------------\n");
  int qnt3 = 8;
  int array4[qnt3] = {83, 58, 79, 35, 12, 65, 40, 20};
  printarArray(array4, qnt3);
  remover(array4, &qnt3);
